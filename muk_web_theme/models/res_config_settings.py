...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        variables = [
            'o-brand-odoo',
            'o-brand-primary',
            'nilai-required-color',
            'nilai-apps-color',
            'nilai-appbar-color',
            'nilai-appbar-background',
        ]
        ...
        colors_changed.append(self.theme_color_required != colors['nilai-required-color'])
        colors_changed.append(self.theme_color_menu != colors['nilai-apps-color'])
        colors_changed.append(self.theme_color_appbar_color != colors['nilai-appbar-color'])
        colors_changed.append(self.theme_color_appbar_background != colors['nilai-appbar-background'])
        if(any(colors_changed)):
            variables = [
                ...
                {'name': 'nilai-required-color', 'value': self.theme_color_required or "#d1dfe6"},
                {'name': 'nilai-apps-color', 'value': self.theme_color_menu or "#f8f9fa"},
                {'name': 'nilai-appbar-color', 'value': self.theme_color_appbar_color or "#dee2e6"},
                {'name': 'nilai-appbar-background', 'value': self.theme_color_appbar_background or "#000000"},
            ]
    ...
    def get_values(self):
        ...
        res.update({
            ...
            'theme_color_required': colors['nilai-required-color'],
            'theme_color_menu': colors['nilai-apps-color'],
            'theme_color_appbar_color': colors['nilai-appbar-color'],
            'theme_color_appbar_background': colors['nilai-appbar-background'],
        })
        return res
